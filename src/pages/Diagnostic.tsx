  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-card border border-gray-100 px-6 py-5">
        ...
        <ul className="space-y-2">
          {r.resources.map((res, i) => (
            <li key={i}>
              <a href={res.url} target="_blank" rel="noopener noreferrer" className="text-sm text-[#1B3A6B] hover:underline">
                → {res.label}
              </a>
            </li>
          ))}
      ...
      <div className="flex flex-wrap gap-3 print:hidden">
        <button onClick={handleCopy} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-gray-200 text-sm text-gray-700 hover:border-[#1B3A6B] transition-colors shadow-card">
          <Copy size={15} />
          {copied ? 'Copié !' : 'Copier le résumé'}
        </button>
        <button onClick={() => window.print()} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-gray-200 text-sm text-gray-700 hover:border-[#1B3A6B] transition-colors shadow-card">
          <Printer size={15} />
          Imprimer / PDF
        </button>
        <button onClick={onRestart} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-gray-200 text-sm text-gray-700 hover:border-[#1B3A6B] transition-colors shadow-card">
          <RotateCcw size={15} />
          Recommencer
        </button>
      </div>
    ...
    <div className="min-h-screen bg-[#FAFAF8]">
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-1">
              {Array.from({ length: TOTAL_STEPS }).map((_, i) => (
                <div key={i} className={['h-1.5 flex-1 rounded-full transition-all duration-300', i < state.step ? 'bg-[#1B3A6B]' : 'bg-gray-200'].join(' ')} />
              ))}
            </div>
          </div>
        </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  ...
                  <OptionCard key={opt.value} {...opt} selected={state.structureType === opt.value} onSelect={v => set('structureType', v)} />
                ))}
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <OptionCard key={opt.value} {...opt} selected={state.financementPct === opt.value} onSelect={v => set('financementPct', v)} />
                ))}
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <OptionCard key={opt.value} {...opt} selected={state.controlCA === opt.value} onSelect={v => set('controlCA', v)} />
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <OptionCard key={opt.value} {...opt} selected={state.controlGestion === opt.value} onSelect={v => set('controlGestion', v)} />
                  ))}
                </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  ...
                  <OptionCard key={opt.value} {...opt} selected={state.prestationType === opt.value} onSelect={v => set('prestationType', v)} />
                ))}
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {montantOptions.map(opt => (
                    <OptionCard key={opt.value} {...opt} selected={state.montant === opt.value} onSelect={v => set('montant', v)} />
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <OptionCard key={opt.value} {...opt} selected={state.subsidieSpecifique === opt.value} onSelect={v => set('subsidieSpecifique', v)} />
                  ))}
                </div>
              </div>
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <OptionCard key={opt.value} {...opt} selected={state.reglesSubsidiant === opt.value} onSelect={v => set('reglesSubsidiant', v)} />
                  ))}
                </div>
        ...
        <div className="mt-6 flex items-center justify-between print:hidden">
          <button onClick={goBack} className="flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-200 bg-white text-sm text-gray-600 hover:border-gray-300 transition-colors shadow-card">
            <ChevronLeft size={16} />
            Retour
          </button>
          <button
            ...
            className={[
              ...
              canProceed() ? 'bg-[#1B3A6B] text-white hover:bg-[#16305A] shadow-brand' : 'bg-gray-100 text-gray-400 cursor-not-allowed',
            ].join(' ')}
          >
