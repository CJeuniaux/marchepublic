...
const FAQS = [
  ...
  { q: "Quel est le seuil à partir duquel un marché public est obligatoire pour une ASBL ?", a: "Il n'existe pas de seuil unique universel. Le premier critère est votre qualité de pouvoir adjudicateur : si vous l'êtes, tous vos marchés sont en principe soumis à la loi du 17 juin 2016, quel que soit le montant. Des procédures allégées s'appliquent en dessous de certains seuils (30 000 € HTVA pour les marchés de faible montant, 140 000 € au-delà duquel une publicité belge s'impose, etc.). Si vous n'êtes pas pouvoir adjudicateur, c'est votre convention de subvention qui fixe les règles." },
  ...
  { q: "Quelle procédure utiliser pour un achat entre 30 000 € et 140 000 € HTVA ?", a: "Si vous êtes pouvoir adjudicateur, vous pouvez généralement recourir à une procédure négociée sans publication préalable pour des marchés de fournitures et services sous 140 000 € HTVA. Cela implique de consulter plusieurs prestataires, de comparer les offres sur des critères définis et de justifier votre choix. Le détail figure à l'article 42 de la loi du 17 juin 2016." },
  { q: "Faut-il publier sur e-Procurement pour tous les marchés publics ?", a: "Non. En dessous de certains seuils (typiquement 30 000 € pour des marchés simples), aucune publication n'est obligatoire. Au-delà, une publication sur l'Espace de Publication des Marchés Publics (e-Procurement) devient nécessaire. Au-delà des seuils européens (216 000 € pour les fournitures et services, 5 404 000 € pour les travaux), une publication au Journal Officiel de l'UE s'ajoute." },
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://www.facebook.com/profile.php?id=61591233125734" target="_blank" rel="noopener noreferrer" aria-label="Facebook marchépublic.be" className="text-aqua/50 hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/company/march%C3%A9public-be/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn marchépublic.be" className="text-aqua/50 hover:text-white transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href="https://www.instagram.com/marchepublic.be/" target="_blank" rel="noopener noreferrer" aria-label="Instagram marchépublic.be" className="text-aqua/50 hover:text-white transition-colors">
